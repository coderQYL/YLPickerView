package com.qyl.pickerview.view;
...
import com.qyl.pickerview.adapter.WheelAdapter;
import com.qyl.pickerview.interfaces.IPickerViewData;
import com.qyl.pickerview.listener.LoopViewGestureListener;
import com.qyl.pickerview.listener.OnItemSelectedListener;
import com.qyl.pickerview.timer.InertiaTimerTask;
import com.qyl.pickerview.timer.MessageHandler;
import com.qyl.pickerview.timer.SmoothScrollTimerTask;
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
    ...
    private void reMeasureTextSize(String contentText) {
        ...
        //设置2条横线外面的文字大小
        paintOuterText.setTextSize(size -4);//秦宇琳添加
    }
