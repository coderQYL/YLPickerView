...
import com.qyl.pickerview.listener.OnDismissListener;
import com.qyl.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public ViewGroup rootView;//附加View 的 根View
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview2, mPickerOptions.decorView, false);
