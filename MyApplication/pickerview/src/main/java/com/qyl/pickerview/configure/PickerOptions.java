package com.qyl.pickerview.configure;
...
import com.qyl.pickerview.listener.OnOptionsSelectChangeListener;
import com.qyl.pickerview.listener.OnOptionsSelectListener;
...
public class PickerOptions {
    ...
    private static final int PICKER_VIEW_BG_COLOR_TITLE = 0xFFffffff;
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.pickerview_options2;
        } else {
